    ...
    return (
        <>
                                        ...
                                        <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                                            <div className="sm:flex sm:items-start">
                                                ...
                                                <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                                    ...
                                                    <div className="mt-2">
                                                        <p className="text-sm text-black-500">Catatan: Untuk memilih {noUrutDipilih ? <span><span className="font-bold text-black">No. Urut {noUrutDipilih}</span> sebagai <span className="font-bold text-black">OSIS SMP AL-KAUTSAR </span></span> : ''}pastikan anda sudah punya kode pemilih valid yang telah panitia berikan.</p>
                                            ...
                                            <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                                ...
                                                <div className="mt-2">
                                                    {noUrutDipilih ? function (){
                                                        let { ketua, wakil, visi, misi, image } = dataStatic.smpCalon[noUrutDipilih]
                                                        return (<p className="text-sm text-black-500">Selamat anda telah berhasil memilih <span className="font-bold text-black">No. Urut {noUrutDipilih} {ketua} & {wakil}</span> sebagai <span className="font-bold text-black">OSIS SMP AL-KAUTSAR</span> nanti. Kalau sudah memilih silahkan lihat perhitungan suara secara live ya!!</p>)
                                                    }() : ''}
                                                </div>
                                            </div>
                                        </div>
            ...
            <div className="fixed z-10 w-[100%]">
                <Header />
                <h1 className="inline-flex w-full justify-center rounded-md bg-indigo-600 px-3 py-2 font-semibold text-white sm:w-auto select-none"><marquee>Pemilihan OSIS SMP AL-KAUTSAR Masa Bakti 2023-2024</marquee></h1>
            </div>
